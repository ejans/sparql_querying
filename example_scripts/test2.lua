 ...
 * 2010-09-20
 *
 * (c) 2014 Evert Jans <evert.jans@kuleuven.be>
 *
...
uri = redland.librdf_new_uri(world,'http://www.dajobe.org/foaf.rdf')
...
query = redland.librdf_new_query(world, 'sparql', null, "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> PREFIX foaf: <http://xmlns.com/foaf/0.1/> SELECT ?nick, ?name WHERE { ?x rdf:type foaf:Person . ?x foaf:nick ?nick . ?x foaf:name ?name}", null)
