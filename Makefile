...
$(NAME3).so: $(NAME3).o $(INCLUDE_DIR)/libubx.so
	        ${CC} $(CFLAGS_SHARED) -o $(NAME3).so $(NAME3).o $(INCLUDE_DIR)/libubx.so -lluajit-5.1  -lpthread

$(NAME3).o: $(NAME3).c $(INCLUDE_DIR)/ubx.h $(INCLUDE_DIR)/ubx_types.h $(INCLUDE_DIR)/ubx.c $(HEXARRS)
	        ${CC} -fPIC -I$(INCLUDE_DIR) -c $(CFLAGS) $(NAME3).c
